 // Liste.h
  ...
  typedef  char Grille[COLONNE];
   extern void construireGrille();
   extern void lireCase(Liste l,int i,int j);
   extern void ecrireCase(Liste *l,int i,int j,Elem val);
   extern void init_Ligne(Ligne line);
